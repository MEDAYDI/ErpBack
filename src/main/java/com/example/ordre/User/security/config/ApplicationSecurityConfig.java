package com.example.ordre.User.security.config;


import com.example.ordre.User.security.filter.JwtAuthorizationFilter;
import com.example.ordre.User.repository.UserRepo;
import com.example.ordre.User.service.UserService;
...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private final String[] PUBLIC_ENDPOINTS = {
            ...
            "/api/order/addmicro",
            "/api/order/updatemicro/{id}",
            "/api/order/delmicro/{id}",
